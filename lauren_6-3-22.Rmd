...
ucr.sum = df4 %>%
  ...
  summarise(ave_duis = formatC(mean(DUI_Total), format = "f", digits = 2),
            sd_dui = sd(DUI_Total),
            ave_white_dui_rate = formatC(mean(white_dui_rate), format = "f", digits = 4),
            sd_white_dui_rate = sd(white_dui_rate, na.rm = T),
            ave_black_dui_rate = formatC(mean(black_dui_rate), format = "f", digits = 4),
            sd_black_dui_rate = sd(black_dui_rate, na.rm = T))
